...
const Navbar = () => {
    ...
    return (
        <nav className="w-full h-10 border-b border-gray-800 flex items-center justify-between font-fira text-[#607B96] ">
            ...
            <motion.nav variants={sidebar} initial={false} animate={menuOpen ? "open" : "closed"} className="fixed top-0 right-0 h-full w-full backdrop-blur-xl z-[1]">
